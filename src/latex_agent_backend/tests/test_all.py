...
No LLM calls here — tests the parser, operations, and serializer in isolation.
"""
import sys, os
sys.path.insert(0, os.path.dirname(os.path.dirname(__file__)))

import pytest
from parser.parser import parse, find_node, to_tree_json
...
FULL_TEX = open(
    os.path.join(os.path.dirname(__file__), "sample-sigconf.tex")
...
class TestRewrite:
    ...
    def test_preserves_figures(self, minimal_tree):
        ...
        from parser.parser import ContentBlock
